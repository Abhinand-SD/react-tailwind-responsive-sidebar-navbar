...
const Slidebar = ({sidebarToggle}) => {
    return (
        <div className={`${sidebarToggle ? "block" : "hidden"} fixed w-64 bg-gray-800 h-full px-4 py-2`}>
            ...
            <ul className='mt-3 text-white font-bold'>
                ...
                <li className='mb-2 rounded hover:shadow hover:bg-blue-500 py-2'>
                    <a href='' className='px-3'>
                        <FaRegEnvelope className='inline-block w-6 h-6 mr-2 -mt-2'></FaRegEnvelope>Index</a>
                </li>

                <li className='mb-2 rounded hover:shadow hover:bg-blue-500 py-2'>
                    <a href='' className='px-3'>
                        <FaCog className='inline-block w-6 h-6 mr-2 -mt-2'></FaCog>Setting</a>
                </li>
            </ul>
